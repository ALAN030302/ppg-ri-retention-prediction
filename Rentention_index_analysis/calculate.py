...
class MzMLCompoundMatcherGUI:
    ...
    def setup_ui(self):
        ...
        # 版本信息
        version_label = tk.Label(content_frame, text="版本 8.0 - 支持化合物匹配与PPG保留指数计算",
                                 font=("Arial", 10))
        ...
        # ==================== 第5步: 进度显示 ====================
        step5_frame = tk.LabelFrame(content_frame, text="第5步: 处理进度", font=("Arial", 12, "bold"),
                                    padx=10, pady=10)
        ...
        # ==================== 第6步: 日志显示 ====================
        step6_frame = tk.LabelFrame(content_frame, text="第6步: 处理日志", font=("Arial", 12, "bold"),
                                    padx=10, pady=10)
...
if __name__ == "__main__":
    ...
    print("  5. 计算化合物的PPG保留指数")
    print("  6. 生成详细的匹配结果和保留指数Excel文件")
    print("=" * 70)
