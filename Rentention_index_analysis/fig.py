...
# -*- coding: utf-8 -*-
"""
PPG retention index calculation and visualization program - complete GUI version
:
...
5. Visualize analysis results and generate reports
...
class PPGIndexAnalyzerGUI:
    ...
    def preview_report(self):
        ...
        # results
        self.notebook.select(3) # results4 (3)
...
if __name__ == "__main__":
    ...
    print(" 5. Visualize analysis results and generate reports")
    print("=" * 70)
